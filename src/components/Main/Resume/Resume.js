  ...
  const experienceData = [
    {
      ...
      company: "LivePerson",
      summary:
        "Specialized in delivering tailored enterprise solutions in a client-facing role, focusing on mobile integrations, API development, and AI-driven deployments. Collaborated closely with clients to design scalable, maintainable systems that enhanced performance and ensured seamless adoption across platforms.",
      description: [
    ...
    },
    {
      ...
      company: "NewDay",
      summary:
        "Focused on front-end development and system observability within a digital engineering team, specializing in modern JavaScript frameworks and performance monitoring solutions. Collaborated with cross-functional teams to enhance internal tools, optimize testing workflows, and improve application reliability across large-scale environments.",
      description: [
    ...
    },
    {
      ...
      company: "Capgemini",
      summary:
        "Contributed to a major energy provider project, focusing on CI/CD pipeline optimization, technical documentation, and seamless project handovers. Collaborated closely with clients and internal teams to ensure high-quality deliverables and efficient development workflows.",
      description: [
    ...
    },
    {
      ...
      company: "QA Limited",
      summary:
        "Completed an intensive 12-week technical training program focused on software engineering fundamentals and full-stack development. Gained hands-on experience building end-to-end applications using Java, Node.js, and the MERN stack.",
      description: [
  ...
  const skillsData = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Grafana",
          icon: "https://img.icons8.com/color/48/000000/grafana.png",
  ...
  return (
    <div id="resume" className="resume-container">
      ...
      <div className="summary">
        Results-driven Software and Solutions Engineer with experience designing
        and deploying scalable digital solutions across enterprise environments.
        Skilled in JavaScript, React, Node.js, and cloud integrations (Azure,
        GCP). Adept at bridging the gap between technical teams and business
        stakeholders to deliver impactful, reliable software solutions.
      </div>

      <h2 className="subheader">Experience & Skills:</h2>
      <div className="experience-horizontal">
        <div className="experience-half">{renderJobs(leftJobs)}</div>
        <div className="experience-half">{renderJobs(rightJobs)}</div>
      </div>
          ...
          <div className="skills-section" key={i}>
            ...
            <div className="skills-icons">
              {section.skills.map((skill, idx) => (
                <a href={skill.link} target="_blank" rel="noreferrer" key={idx}>
                  <img
                    src={skill.icon}
                    alt={skill.name}
